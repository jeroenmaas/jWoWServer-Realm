 ...
 * <P>
 * Taken from Core Servlets and JavaServer Pages from Prentice Hall and Sun Microsystems Press,
 * http://www.coreservlets.com/. &copy; 2000 Marty Hall; may be freely used or adapted.
 */
...
public class ConnectionPool implements Runnable {
    ...
    public ConnectionPool(String driver, String host, String database,
    ...
    private Connection makeNewConnection()
        ...
        try {
            ...
            Connection connection =
                    DriverManager.getConnection("jdbc:mysql://" + host + "/" + database + "?user=" + username
                            + "&password=" + password);
            return (connection);
