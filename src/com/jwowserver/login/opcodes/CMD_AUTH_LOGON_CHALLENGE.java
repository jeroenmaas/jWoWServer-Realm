...
public class CMD_AUTH_LOGON_CHALLENGE extends GenericWowPacketHandler {
	...
	public void handlePacket(CPacket pck) {
		int error = pck.getUInt8();
		int fullSize = pck.getInt16();
		...
		int version1 = pck.getUInt8();
		int version2 = pck.getUInt8();
		int version3 = pck.getUInt8();
		...
		int ip1 = pck.getUInt8();
		int ip2 = pck.getUInt8();
		int ip3 = pck.getUInt8();
		int ip4 = pck.getUInt8();
		...
		String secretAccountHash = new ShaInstance().update(data.randomInt.toByteArray()).updateLittleEndian(shaPasswordBytes).getDigestStr();
